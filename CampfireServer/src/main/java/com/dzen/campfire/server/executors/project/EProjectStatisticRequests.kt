...
class EProjectStatisticRequests : RProjectStatisticRequests(0, 0) {
    ...
    override fun execute(): Response {
        /*val select = SqlQuerySelect(TStatistic.NAME,
                ...
                .where(TStatistic.statistic_type, "=", ControllerStatistic.TYPE_REQUEST)
        ...
        return Response(Array(v.rowsCount) {
            val statistic = StatisticRequest()
