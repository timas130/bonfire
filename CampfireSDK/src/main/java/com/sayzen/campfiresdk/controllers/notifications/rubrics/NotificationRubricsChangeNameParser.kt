...
public class NotificationRubricsChangeNameParser(override val n: NotificationRubricsChangeName) : ControllerNotifications.Parser(n) {
    ...
    override fun getTitle(): String {
        return tCap(API_TRANSLATE.notification_rubric_change_name, n.adminName, ToolsResources.sex(n.adminSex, t(API_TRANSLATE.he_changed), t(API_TRANSLATE.she_changed)), n.rubricOldName, n.rubricNewName)
    }
