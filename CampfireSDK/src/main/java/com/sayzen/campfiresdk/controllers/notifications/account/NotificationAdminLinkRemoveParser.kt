...
public class NotificationAdminLinkRemoveParser(override val n: NotificationAdminLinkRemove) : ControllerNotifications.Parser(n) {
    ...
    override fun getTitle(): String {
        return tCap(
                API_TRANSLATE.notification_admin_link_remove, n.adminName, ToolsResources.sex(
                n.adminSex,
