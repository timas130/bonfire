...
public class NotificationAdminPostRemoveMediaParser(override val n: NotificationAdminPostRemoveMedia) :
    ...
    override fun getTitle(): String {
        return tCap(
                API_TRANSLATE.notification_admin_post_media_remove, n.adminName, ToolsResources.sex(
                n.adminSex,
