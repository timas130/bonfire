...
class SplashFilters(var onChanged: () -> Unit) : Splash(R.layout.screen_feed_splash_filters) {
    ...
    private val vClosed: SettingsCheckBox = findViewById(R.id.vClosed)
    ...
    init {
        ...
        vClosed.setChecked(ControllerSettings.feedClosed)
        vClosed.setTitle(t(API_TRANSLATE.feed_closed))
    ...
    private fun saveAndHide() {
        ...
        ControllerSettings.feedClosed = vClosed.isChecked()
