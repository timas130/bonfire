...
public class NotificationFandomViceroyRemoveParser(override val n: NotificationFandomViceroyRemove) :
    ...
    override fun getTitle(): String {
        return if (ToolsText.empty(n.comment)) "" else " " +
                t(API_TRANSLATE.notifications_fandom_viceroy_remove, n.adminAccountName, ToolsResources.sex(n.adminAccountSex, t(API_TRANSLATE.he_denied), t(API_TRANSLATE.she_denied)), n.fandomName)
    }
