...
public class NotificationRubricsRemoveParser(override val n: NotificationRubricsRemove) : ControllerNotifications.Parser(n) {
    ...
    override fun getTitle(): String {
        return tCap(API_TRANSLATE.notification_rubric_remove, n.adminName, ToolsResources.sex(n.adminSex, t(API_TRANSLATE.he_remove), t(API_TRANSLATE.she_remove)), n.rubricName)
    }
