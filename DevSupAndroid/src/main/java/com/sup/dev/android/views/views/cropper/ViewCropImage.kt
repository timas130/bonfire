...
class ViewCropImage @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : FrameLayout(context, attrs) {
    ...
    init {
        ...
        options.scaleType = ScaleType.values()[a.getInt(R.styleable.ViewCropImage_sup_cropScaleType, options.scaleType.ordinal)]
        options.cropShape = CropShape.values()[a.getInt(R.styleable.ViewCropImage_sup_cropShape, options.cropShape.ordinal)]
        options.guidelines = Guidelines.values()[a.getInt(R.styleable.ViewCropImage_sup_cropGuidelines, options.guidelines.ordinal)]
        options.fixAspectRatio = a.getBoolean(R.styleable.ViewCropImage_sup_cropFixAspectRatio, options.fixAspectRatio)
        options.aspectRatioX = a.getInteger(R.styleable.ViewCropImage_sup_cropAspectRatioX, options.aspectRatioX)
        options.aspectRatioY = a.getInteger(R.styleable.ViewCropImage_sup_cropAspectRatioY, options.aspectRatioY)
        options.autoZoomEnabled = a.getBoolean(R.styleable.ViewCropImage_sup_cropAutoZoomEnabled, options.autoZoomEnabled)
        options.multiTouchEnabled = a.getBoolean(R.styleable.ViewCropImage_sup_cropMultiTouchEnabled, options.multiTouchEnabled)
        options.maxZoom = a.getInteger(R.styleable.ViewCropImage_sup_cropMaxZoom, options.maxZoom)
        options.snapRadius = a.getDimension(R.styleable.ViewCropImage_sup_cropSnapRadius, options.snapRadius)
        options.touchRadius = a.getDimension(R.styleable.ViewCropImage_sup_cropTouchRadius, options.touchRadius)
        options.initialCropWindowPaddingRatio = a.getFloat(R.styleable.ViewCropImage_sup_cropInitialCropWindowPaddingRatio, options.initialCropWindowPaddingRatio)
        options.borderLineThickness = a.getDimension(R.styleable.ViewCropImage_sup_cropBorderLineThickness, options.borderLineThickness)
        options.borderLineColor = a.getInteger(R.styleable.ViewCropImage_sup_cropBorderLineColor, options.borderLineColor)
        options.borderCornerThickness = a.getDimension(R.styleable.ViewCropImage_sup_cropBorderCornerThickness, options.borderCornerThickness)
        options.borderCornerOffset = a.getDimension(R.styleable.ViewCropImage_sup_cropBorderCornerOffset, options.borderCornerOffset)
        options.borderCornerLength = a.getDimension(R.styleable.ViewCropImage_sup_cropBorderCornerLength, options.borderCornerLength)
        options.borderCornerColor = a.getInteger(R.styleable.ViewCropImage_sup_cropBorderCornerColor, options.borderCornerColor)
        options.guidelinesThickness = a.getDimension(R.styleable.ViewCropImage_sup_cropGuidelinesThickness, options.guidelinesThickness)
        options.guidelinesColor = a.getInteger(R.styleable.ViewCropImage_sup_cropGuidelinesColor, options.guidelinesColor)
        options.backgroundColor = a.getInteger(R.styleable.ViewCropImage_sup_cropBackgroundColor, options.backgroundColor)
        options.showCropOverlay = a.getBoolean(R.styleable.ViewCropImage_sup_cropShowCropOverlay, mShowCropOverlay)
        options.showProgressBar = a.getBoolean(R.styleable.ViewCropImage_sup_cropShowProgressBar, mShowProgressBar)
        options.borderCornerThickness = a.getDimension(R.styleable.ViewCropImage_sup_cropBorderCornerThickness, options.borderCornerThickness)
        options.minCropWindowWidth = a.getDimension(R.styleable.ViewCropImage_sup_cropMinCropWindowWidth, options.minCropWindowWidth.toFloat()).toInt()
        options.minCropWindowHeight = a.getDimension(R.styleable.ViewCropImage_sup_cropMinCropWindowHeight, options.minCropWindowHeight.toFloat()).toInt()
        options.minCropResultWidth = a.getFloat(R.styleable.ViewCropImage_sup_cropMinCropResultWidthPX, options.minCropResultWidth.toFloat()).toInt()
        options.minCropResultHeight = a.getFloat(R.styleable.ViewCropImage_sup_cropMinCropResultHeightPX, options.minCropResultHeight.toFloat()).toInt()
        options.maxCropResultWidth = a.getFloat(R.styleable.ViewCropImage_sup_cropMaxCropResultWidthPX, options.maxCropResultWidth.toFloat()).toInt()
        options.maxCropResultHeight = a.getFloat(R.styleable.ViewCropImage_sup_cropMaxCropResultHeightPX, options.maxCropResultHeight.toFloat()).toInt()
        options.flipHorizontally = a.getBoolean(R.styleable.ViewCropImage_sup_cropFlipHorizontally, options.flipHorizontally)
        options.flipVertically = a.getBoolean(R.styleable.ViewCropImage_sup_cropFlipHorizontally, options.flipVertically)
        isSaveBitmapToInstanceState = a.getBoolean(R.styleable.ViewCropImage_sup_cropSaveBitmapToInstanceState, isSaveBitmapToInstanceState)
        if (a.hasValue(R.styleable.ViewCropImage_sup_cropAspectRatioX)
                && a.hasValue(R.styleable.ViewCropImage_sup_cropAspectRatioX)
                && !a.hasValue(R.styleable.ViewCropImage_sup_cropFixAspectRatio)) {
